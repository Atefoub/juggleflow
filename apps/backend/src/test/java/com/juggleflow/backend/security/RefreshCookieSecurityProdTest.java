...
@ActiveProfiles("test")
class RefreshCookieSecurityProdTest {
  ...
  @Test
  @DisplayName("Register sets refresh cookie (prod) with httpOnly + SameSite=Strict + path=/api/auth and Secure")
  void register_setsRefreshCookieAttributes_prod() throws Exception {
    RegisterRequest req = buildRegister("cookie-prod@test.fr");

...
export default function TeacherDashboardPage() {
  ...
  return (
    <div className="flex flex-1 flex-col w-full min-h-0">
      ...
      {/* Header */}
      <div className="px-5 pt-4 pb-4 md:pt-6 md:px-0 bg-bg-header border-b border-border">
      ...
      {/* Contenu */}
      <div className="flex-1 overflow-y-auto px-5 py-4 md:px-0 grid grid-cols-1 gap-5 md:grid-cols-2 md:gap-6 md:items-start">

        {/* Erreur */}
        {error && (
          <div className="p-4 rounded-2xl text-sm text-center text-alert bg-alert-surface border border-alert md:col-span-2">
            {error}
          </div>
        )}
        ...
        {!loading && !error && (
          <>
            {/* Progression moyenne */}
            <div className="p-4 rounded-2xl flex items-center gap-4 bg-bg-card border border-border md:col-span-1">
              <div className="flex-1">
            ...
            {exerciseBlockedStudents.length > 0 && selectedClass && (
              <div className="flex items-start gap-3 rounded-2xl border border-border border-l-[3px] border-l-brand-end bg-accent-surface p-4 md:col-span-2">
            ...
            {/* Aucune classe */}
            {classes.length === 0 && (
              <div className="p-4 rounded-2xl text-sm bg-bg-card border border-border text-text-secondary md:col-span-2">
            ...
            {reportPickerOpen && selectedClass && sortedAssignedPaths.length > 1 && (
              <section className="p-4 rounded-2xl bg-bg-card border border-border md:col-span-2">
                <div className="flex items-center justify-between mb-3">

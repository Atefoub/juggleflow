...
export default function PwaUpdateBanner() {
  ...
  return (
    <div
      role="status"
      className="fixed top-0 inset-x-0 z-50 flex items-center justify-between gap-3 px-4 py-3 bg-accent-surface border-b border-brand/40 shadow-lg max-w-shell mx-auto md:max-w-shell-md lg:max-w-shell-lg"
    >
